...
export class EmailSearchResultsComponent {
  ...
  paginationConfig={
    ...
    displayedColumns: string[] = ['select', 'familyId', 'primaryName', 'registrationStatus', 'paymentStatus','choiceCode','sessionAssignmentDescription', 'TemplateID','email','emailSentDate'];
